...
<div>
    ...
    <div class="flex lg:flex-nowrap flex-wrap justify-center lg:w-1/2 w-full mx-auto">
        <input type="text" id="text" class="bg-white rounded-md border border-gray-200 px-4 py-2 placeholder:text-slate-400 focus:outline-none w-full focus:ring-1 focus:ring-red-200" placeholder="Category Name" v-model="enterTask" >
